 ...
 * 本 Model 接口几乎没有实现任何快捷方法，你需要通过额外调用本类中的 {@link #getSpecExecutor()} 方法来实现
 * {@link JpaSpecificationExecutor} 中的相关功能。
 * </p>
 *
 * @param <T> 实体类的泛型参数
 * @param <E> 实体类所对应的 Repository 接口，且它继承了 JpaSpecificationExecutor 接口
 * @author blinkfox on 2022-03-30.
 * @since 2.7.0
 */
public interface SpecModel<T, E extends JpaSpecificationExecutor<T>> extends BaseModel<T> {

    /**
     * 懒加载获取本实体类所对应的 Repository（{@link E}）对象，该对象需要继承自 {@link JpaSpecificationExecutor} 接口.
     *
