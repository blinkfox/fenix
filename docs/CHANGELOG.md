...
### ✨ v4.0.0 适配 SpringBoot 4.x 的版本 🆕 (2025-12-03) :id=v400

- 适配 SpringBoot 4.x 的版本；

### 🏡️ v3.1.0 新增多种主键生成策略的注解 (2025-07-23) :id=v310

- 新增多种主键生成策略的注解和修改各策略的实现接口，以适配 Hibernate 新的版本；

### 🏜️ v3.0.1 适配 SpringBoot 3.4.x 和 3.5.x 的版本 (2025-07-20) :id=v301
